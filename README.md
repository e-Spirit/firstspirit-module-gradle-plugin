...
```kotlin
plugins {
    id("de.espirit.firstspirit-module") version "8.0.2"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-annotations") version "8.0.2"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-configurations") version "8.0.2"
}
```
