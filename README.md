...
```kotlin
plugins {
    id("de.espirit.firstspirit-module") version "4.0.0"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-annotations") version "2.0.0"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-configurations") version "4.0.0"
}
```
