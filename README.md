...
```kotlin
plugins {
    id("de.espirit.firstspirit-module") version "9.0.2"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-annotations") version "9.0.2"
}
```
...
```kotlin
plugins {
    id("de.espirit.firstspirit-module-configurations") version "9.0.2"
}
```
